...
5. **9 月 1 日 13:00 PDT 前（功能冻结）**：独立部署、公网验收、英文 README、架构图和截图；此后不增加功能。
6. **9 月 2 日 13:00 PDT 前（材料冻结）**：完成少于 3 分钟的英文公开视频、Devpost 文案和合规检查。
7. **9 月 3 日 10:00 PDT 前（提交）**：正式提交并核验 `Submitted`，在官方 13:00 PDT 截止前保留 3 小时缓冲。
